  ...
  ),
  {
    variants: {
      variant: {
        ...
        teal: cn(
          "bg-teal-500 active:bg-teal-600 shadow-sm shadow-black/5",
          Platform.select({ web: "hover:bg-teal-600" }),
        ),
        purple: cn(
          "bg-purple-500 active:bg-purple-600 shadow-sm shadow-black/5",
          Platform.select({ web: "hover:bg-purple-600" }),
        ),
        gray: cn(
